...
const ExclusiveOffer = () => {
  return (
    <div className='flex flex-col items-start px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
      <div className='flex flex-col md:flex-row items-start justify-between w-full gap-4'>
        ...
        />
        <button className='group flex items-center gap-2 font-medium cursor-pointer md:mt-8 self-end'>
          View All Offers
